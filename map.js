 var buildings = [
        ...
        function initialize() {
            ...
            var map = new google.maps.Map(document.getElementById('map-canvas'),
                    myMap.mapOptions[0]);
            var mapMarkerContent = function(obj){
                return [
                    '<div class="map-marker">',
                        '<header>'+ obj.name +'</header>',
                        '<main>'+ obj.address +'</main>',
                        '<footer>'+ obj.phone +'</footer>',
                    '</div>'
                ].join('\n');
            };
            for(var b in buildings){
                ...
                var building = buildings[b];
                    ...
                    building.marker = new MarkerWithLabel({
                        ...
                        map: map,
                        icon: myMap.mapPin[0],
                        content: mapMarkerContent(building)
                    });
            
                
                google.maps.event.addListener(building.marker, 'click', function(e){
                    building.infowindow.setContent(this.content);
